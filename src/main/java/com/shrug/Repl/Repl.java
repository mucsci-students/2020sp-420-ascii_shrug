...
public class Repl {
   ...
   *
   * Postcondition: returns an array with commands parsed into an array by space.
   */
  ...
  /*
   * Method: execute (String[] cmds) cmds is a list of the arguments on the command line, space delimited.
   *
  ...
  /*
   * Function: exit () precondition: program is running and exit is entered into Repl. postcondition: program is
   * terminated.
   */
